        ...
        <div class="patoi-nav">
            <div class="container">
                <nav class="navbar navbar-expand-md navbar-light">
                    <a class="navbar-brand" href="home.php"><img src="public/img/logo.png" alt="logo"></a>
                    <div class="collapse navbar-collapse mean-menu">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                <a href="about_us.php?about_us" class="nav-link <?php echo isset($_GET['about_us']) ? "active" : " "; ?>">GIỚI
                                    THIỆU</a>
                            </li>
                        </ul>
                        <div class="others-option">
                            <div class="d-flex align-items-center">
                                <ul>
                                    ...
                                    <li><a href="cart.php"><i class='bx bx-cart'></i><span style="<?php echo $css; ?> padding: 2px 6px; font-weight: 500; font-size: 14px; background-color: #f87171; border-radius: 50%;">
                                                <?php echo $so; ?>
                                            </span></a></li>
                                </ul>
                            </div>
                    ...
                    <div class="option-inner">
                        <div class="others-option">
                            <ul>
                                ...
                                <li><a href="cart.php"><i class='bx bx-cart'></i><span style=" padding: 2px 6px; font-weight: 500; font-size: 14px; background-color: red; border-radius: 50%;">1</span></a>
                                </li>
                            </ul>
                        </div>
                    </div>
