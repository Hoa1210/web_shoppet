        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 col-md-12">
                <div class="main-banner-image">
                    ...
                    <img src="public/img/banner/banner2.png" alt="banner-image">
    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-offer-box">
                    <a href="shop.php?shop" class="d-block">
                        <img src="public/img/offer/offer2.jpg" alt="offer-image">
                    </a>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="single-offer-box">
                    <a href="shop.php?shop" class="d-block">
                        <img src="public/img/offer/offer3.jpg" alt="offer-image">
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="categories-slides owl-carousel owl-theme">
            <div class="single-categories-box">
                <a href="#" class="d-block">
                    <img src="public/img/categories/categories1.jpg" alt="categories-image">
                    <h3>Thực phẩm cho chó</h3>
                </a>
            </div>
            <div class="single-categories-box">
                <a href="#" class="d-block">
                    <img src="public/img/categories/categories2.jpg" alt="categories-image">
                    <h3>Thực phẩm cho mèo</h3>
                </a>
            </div>
            <div class="single-categories-box">
                <a href="#" class="d-block">
                    <img src="public/img/categories/categories3.jpg" alt="categories-image">
                    <h3>Phụ kiện</h3>
                </a>
            </div>
            <div class="single-categories-box">
                <a href="#" class="d-block">
                    <img src="public/img/categories/categories4.jpg" alt="categories-image">
                    <h3>Thực phẩm khô</h3>
                </a>
            </div>
            <div class="single-categories-box">
                <a href="#" class="d-block">
                    <img src="public/img/categories/categories5.jpg" alt="categories-image">
                    <h3>Đồ chơi thú cưng</h3>
                </a>
            </div>
            <div class="single-categories-box">
                <a href="#" class="d-block">
                    <img src="public/img/categories/categories6.jpg" alt="categories-image">
                        ...
                        <div class="single-products-box">
                            <div class="image">
                                <a   onclick="window.location.href='products_details.php?action=add1&&ma_sp=<?php echo $value->ma_sp; ?>'" class="d-block">
                                    <img   src="../backend/public/imageproduct/<?php echo $value->hinh_anh ?>" alt="products-image">
                                </a>
                                <?php
                                if ($value->so_luong == 0) {
                                    $css = "sold";
                    ...
                    <div class="col-xl-6 col-lg-12 col-md-12 col-sm-12">
                        <div class="offer-box">
                            <div class="row align-items-center">
                                <div class="col-lg-6 col-md-6">
                                    <div class="image">
                                        <img src="../backend/public/imageproduct/<?php echo $value->hinh_anh; ?>" alt="offer-image">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6">
                                    <div class="content">
                                        <h3><a href="#"><?php echo $value->ten_sp; ?></a></h3>
                                        <span class="price"><span class="new-price"><?php echo number_format($value->gia_ban) ?> VND</span></span>
                                        <div class="rating">
                                            <i class='bx bxs-star'></i>
                                            <i class='bx bxs-star'></i>
                                            <i class='bx bxs-star'></i>
                                        ...
                                        <div class="counter-class" data-date="2023-12-25 24:00:00">
                                            <div><span class="counter-days"></span> Ngày</div>
                                            <div><span class="counter-hours"></span> Giờ</div>
                                            <div><span class="counter-minutes"></span> Phút</div>
                                            <div><span class="counter-seconds"></span> Giây</div>
                                        </div>
                                        <a  class="default-btn"onclick="window.location.href='products_details.php?ma_sp=<?php echo $value->ma_sp; ?>'"><span>Xem Ngay</span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <?php endif; if ($key < 3 && $key > 0) :?>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6">
                <div class="single-blog-post">
                    <div class="image">
                        <a href="#" class="d-block">
                            <img src="public/img/blog/blog1.jpg" alt="blog-image">
                        </a>
                    </div>
                    <div class="content">
                        <span class="date">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-blog-post">
                    <div class="image">
                        <a href="#" class="d-block">
                            <img src="public/img/blog/blog2.jpg" alt="blog-image">
                        </a>
                    </div>
                    <div class="content">
                        <span class="date">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-blog-post">
                    <div class="image">
                        <a href="#" class="d-block">
                            <img src="public/img/blog/blog3.jpg" alt="blog-image">
                        </a>
                    </div>
                    <div class="content">
                        <span class="date">
