        ...
        <div class="row align-items-center">
            <div class="col-lg-3 col-md-12">
                <div class="about-image">
                    <img src="public/img/about/about1.jpg" alt="about-image">
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-12">
                <div class="about-image">
                    <img src="public/img/about/about2.jpg" alt="about-image">
                </div>
            </div>
        </div>
    </div>
...
<div class="feedback-area pb-100">
    <div class="container">
        <div class="section-title">
            <h2>Khách hàng nghĩ gì về chúng tôi</h2>
        </div>
        <div class="row align-items-center">
            <div class="col-lg-6 col-md-12">
                <div class="feedback-slides owl-carousel owl-theme">
                    <div class="single-feedback-box">
                        ...
                        <div class="client-info">
                            <img src="public/img/user/user1.jpg" alt="user">
                            <h3>A</h3>
                            <span>Manager</span>
                        </div>
                    </div>
                    <div class="single-feedback-box">
                        ...
                        <div class="client-info">
                            <img src="public/img/user/user2.jpg" alt="user">
                            <h3>C</h3>
                            <span>Developer</span>
                        </div>
                    </div>
                    <div class="single-feedback-box">
                        ...
                        <div class="client-info">
                            <img src="public/img/user/user3.jpg" alt="user">
                            <h3>B</h3>
            ...
            <div class="col-lg-6 xol-md-12">
                <div class="video-box">
                    <img src="public/img/video.jpg" alt="video-image">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="single-team-member">
                    <img src="public/img/team/team1.jpg" alt="team-image">
                    <h3>C</h3>
                    <span>Business Analyst</span>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="single-team-member">
                    <img src="public/img/team/team2.jpg" alt="team-image">
                    <h3>B</h3>
                    <span>CEO</span>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="single-team-member">
                    <img src="public/img/team/team3.jpg" alt="team-image">
                    <h3>A</h3>
                    <span>Developer</span>
                </div>
            </div>
